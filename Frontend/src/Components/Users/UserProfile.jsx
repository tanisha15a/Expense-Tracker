...
const UserProfile = () => {
  ...
  return (
    <>
      <div className="max-w-4xl mx-auto my-10 p-8 bg-gradient-to-r from-blue-400 to-green-500  rounded-lg shadow-md">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              ...
              <input
                ...
                type="text"
                id="username"
                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-4 focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-200"
