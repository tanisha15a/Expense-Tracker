...
const AddCategory = () => {
  ...
  return (
    <form
      ...
      className="max-w-lg mx-auto my-10 bg-gradient-to-r from-blue-400 to-green-500  p-6 rounded-lg shadow-lg space-y-6"
    >
      ...
      <div className="flex flex-col">
        <label htmlFor="name" className="text-gray-700 font-medium">
          <SiDatabricks className="inline mr-2 text-blue-800" />
          Name
        </label>
        <input
          type="text"
      ...
      <button
        type="submit"
        className="mt-4 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition-colors duration-200 transform"
      >
        Add Category
      </button>
    </form>
